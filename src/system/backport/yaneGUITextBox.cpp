...
void CGUITextBox::SetFont(YTL::smart_ptr<CFont> font) {
    if (m_vTextFastPlane != NULL) {
		...
		// TODO: copy over all properties or make more function wrappers for all important not controlled by HTML
		//m_vTextFastPlane->SetDefaultColor(font->GetColor());
