//  CFSjisConverter.h
//		SJISをそのままワイドバイトに変換するクラス（UNICODEへの変換ではない）
//			programmed by coLun	'03/05/12 - '03/05/19

#ifndef __CFSjisConverter_h__
#define __CFSjisConverter_h__
...
class CFSjisConverter : public IJcodeConverter{
public:
	virtual ~CFSjisConverter(){};
