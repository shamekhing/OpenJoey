...
#include "stdafx.h" // プリコンパイル済みヘッダの追加 by yaneurao
#include "md5.h"	//	md5.hh -> md5.h にファイル名変更した by yaneurao

#include <assert.h>
#include <string>	//	strings.h -> string
...
//	このコンストラクタの実装忘れてまっせー(;´Д`)
	init();  // must be called be all constructors
	update(str,::lstrlen((char*)str));
	finalize ();
}
